...
namespace MapleLib.WzLib.WzStructure
{
    public class MapInfo //Credits to Bui for some of the info
    {
        ...
        public void Save(WzImage dest)
        {
            ...
            info["mapDesc"] = InfoTool.SetString(mapDesc);
            ...
            info["onFirstUserEnter"] = InfoTool.SetString(onFirstUserEnter);
            info["onUserEnter"] = InfoTool.SetString(onUserEnter);
            ...
            info["reactorShuffleName"] = InfoTool.SetString(reactorShuffleName);
            info["personalShop"] = InfoTool.SetBool(personalShop);
            info["entrustedShop"] = InfoTool.SetBool(entrustedShop);
            info["effect"] = InfoTool.SetString(effect);
            ...
            info["help"] = InfoTool.SetString(help);
            ...
            info["streetName"] = InfoTool.SetString(streetName);
            ...
            foreach (IWzImageProperty prop in additionalProps) 
            {
